...
public class GreetingController {
    ...
    public String greeting(@RequestParam(value="name", defaultValue="World") String name) {
	    ...
	    for (WatchList list : repository.findAll()) {
			...
			contents = contents + "<tr><td><a href=# target='_blank' onclick=window.open('http://52.90.15.220:8080/listDetails.html','mywin','width=500,height=200'); >" + list.listName +"</a></td>"
        ...
        "<tr><td><a href=# target='_blank' onclick=window.open('http://52.90.15.220:8080/createpage','mywin','width=500,height=200'); >Create List</a></td></tr>"+
